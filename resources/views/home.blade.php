    ...
    <header id="header" class="fixed-top">
      ...
      <nav id="navbar" class="navbar">
          <ul>
            ...
            <li>
              <a class="nav-link scrollto" href="#services">Departemen</a>
            </li>
      ...
      <div class="container">
        <div class="row">
          ...
          >
            ...
            <h2>
              "Himatif salam koding..." adalah mantra yang menggema di
              ruang-ruang kuliah, laboratorium, dan komunitas-komunitas
              pengembang di seluruh penjuru. Itu lebih dari sekadar kata-kata;
              itu adalah simbol dari semangat kolaboratif, eksplorasi tak
              terbatas, dan dedikasi terhadap kemajuan teknologi.
            </h2>
            <div class="d-flex justify-content-center justify-content-lg-start">
              <a href="#pricing" class="btn-get-started scrollto mb-5"
                >Lihat Event</a
              >
        ...
        <div class="container-fluid" data-aos="fade-up">
          <div class="row">
            ...
            <div
              ...
              style="background-image: url('img/team/gantari1.png"
              data-aos="zoom-in"
              data-aos-delay="150"
            >
              &nbsp;
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div>
            ...
            <div class="row">
              ...
              <div
                class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0 opacity-0"
                data-aos="zoom-in"
                data-aos-delay="400"
              >
                <div class="icon-box">
                  <div class="icon"><i class="bx bx-layer"></i></div>
                  <h4><a href="">Pasif</a></h4>
                  <p>
                    At vero eos et accusamus et iusto odio dignissimos ducimus
                    qui blanditiis
                  </p>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-links">
              ...
              <div class="social-links mt-3">
                <a
                  href="https://www.instagram.com/himatifubp?igsh=MW5xaWxlMDI4NWNvZA=="
                  target="_blank"
                  class="instagram"
