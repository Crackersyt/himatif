  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="#why-us">Proker</a></li>
    ...
    <main id="main">
      ...
      <!-- ======= Pricing Section ======= -->
      <section id="aspirasi" class="contact bg-light">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
      ...
      <div>
          ...
          <div class="modal-dialog" role="document">
            <form action="" method="POST" class="modal-content">
              ...
              <div class="modal-body">
                <div>
                  <div class="form-group">
                    <label for="nik" class="col-form-label">Nama</label>
                    <div
                  ...
                  <div class="form-group">
                    <label for="nama" class="col-form-label">NIM</label>
                    <div
                      class="d-flex flex-row align-items-center"
                  ...
                  <div class="form-group">
                    <label for="nama" class="col-form-label">No Whatsapp</label>
                    <div
                      class="d-flex flex-row align-items-center"
                      id="fgroup-saran-nama"
                    >
                  ...
                  <div class="form-group">
                    <label for="nama" class="col-form-label">Batch</label>
                    <div
                      class="d-flex flex-row align-items-center"
                      id="fgroup-saran-nama"
                    >
        ...
        >
          <div class="modal-dialog" role="document">
            <form action="" method="POST" class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Pendaftaran UTD 7</h5>
                <button
                  type="button"
                  class="close"
                  data-bs-dismiss="modal"
